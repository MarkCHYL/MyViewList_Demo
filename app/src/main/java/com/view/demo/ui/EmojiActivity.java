...
public class EmojiActivity extends AppCompatActivity implements View.OnClickListener, ExpressionGridFragment.ExpressionClickListener,ExpressionGridFragment.ExpressionDeleteClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_emoji_et);
        initView();
        initEvent();
    }
    ...
    private void setRootOnTouchListener() {
        rl_root.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                hideKeyboard(EmojiActivity.this);
                return false;
            }
        });
    }
