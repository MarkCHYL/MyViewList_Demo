...
public class CountDownView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(mCircleRadius * 4, mCircleRadius * 4);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //画圆弧
        @SuppressLint("DrawAllocation") RectF rectF = new RectF(0 + (mPaintArcWidth / 2), 0 + mPaintArcWidth / 2
